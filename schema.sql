CREATE TABLE pilgrimages (
  ...
  tirthankar_symbol VRACHAR(50),
  temple_name VRACHAR(255),
  history_importance TEXT,
  why_it_isfamous TEXT,
...
CREATE TABLE nearby_historical_places (
  id INT PRIMARY KEY AUTO_INCREMENT,
  pilgrimage_id INT,
  place_name VRACHAR(255),
  location VRACHAR(255),
  distance VARCHAR(50),
  description TEXT,
...
CREATE TABLE nearby_jain_temples (
  ...
  sect VARCHAR(50),
  description TEXT,
  FOREIGN KEY (pilgrimages_id) REFERENCES pilgrimages(id)
);
